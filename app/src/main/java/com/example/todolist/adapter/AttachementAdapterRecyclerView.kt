...
class AttachementAdapterRecyclerView(private val attachments: MutableList<Attachment>, private val onDeleteClick: (Attachment) -> Unit) :
    RecyclerView.Adapter<AttachementAdapterRecyclerView.AttachmentViewHolder>(){
